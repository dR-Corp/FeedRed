...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        ...
                        <h3>F</h3>
                        <p class="text-md">Envie de gagner du temps pour la rédaction de vos articles ? <br>
                        Nous mettons à profit notre expertise pour vous fournir des articles d'excellente qualité <br>
                        en très peu de temps ! <br></p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>Article optimisé SEO</h4>
                        <p>Nous rédigeons des articles de très bonnes qualités sur des thématiques très variées. Nous suivons à la lettre vos instructions afin de fournir l’article dont vous avez réellement besoin.</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h4>Commandez plus de 200 articles par mois</h4>
                        <p>Pour les agences SEO ou les détenteurs de plusieurs blogs, nous pouvons sous-traiter la rédaction de tout votre contenu avec une garantie de qualité optimale. Notre équipe de rédaction à beaucoup d’expérience, confiez nous la rédaction de vos articles sans crainte.</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h4>Délais de rédaction très courts</h4>
                        <p>Nos délais de rédaction varient entre 5 heures et 24 heures selon le volume de  votre commande. Nous pouvons livrer plus de 25 articles par jour pour les demandes urgentes de contenu.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-5 ml-xl-auto">
                        <div class="special_description_content">
                            ...
                            <p>
                                Nous optimisons nos articles selon les requêtes que vous visiez et vous aidons à en accroître la visibilité. <br>
                                Nous choisir c'est opter pour le meilleur du contenu sur le Web 2.0, accessible à temps et utile pour vos lecteurs. <br>
                                De plus vous pouvez profiter chez nous d'une multitude d'autres services à bons prix.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <p>Nous vous aidons à mettre en place une stratégie de contenu pour monter votre site sur les recherches Google sur une requête.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <p>Nous pouvons vous aider à posséder un blog pour votre activité pour attirer des visiteurs sur votre site. Selon votre activité, nous créeront du contenu de bonne qualité pour attirer des visiteurs via les recherches Google.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <p>Nous intégrons directement vos articles sur votre site avec les images et les différentes optimisation SEO (Option facultative).</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-6 text-center">
                    <div class="single-feature">
                        <h5><i class="ti-desktop text-danger" aria-hidden="true"></i>  Compte client</h5>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores laudantium officia aperiam, eius esse mollitia corporis voluptas perspiciatis iure, explicabo, animi id cum. Ducimus veritatis blanditiis, quae alias nulla beatae?.</p>
                        <a href="page-produit.html" class="btn btn-danger rounded-lg btn-sm mt-3">Plus de détails</a>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-3"></div>
    ...
    <!-- ***** Video Area End ***** -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="video-area" style="background-image: url(<?= ASSETS ?>orlib/img/bg-img/video.jpg);">
                        <div class="video-play-btn">
                            <a href="https://www.youtube.com/watch?v=f5BBJ4ySgpo" class="video_btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special wow fadeInDown" data-wow-delay="0.2s">
                        ...
                        <p>Le salon est la pièce représentant le cœur de la maison où la famille se retrouve et reçoit ses connaissances. Il ne doit pas donc être aménager à la légère. Il faut un agencement qui...</p>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special wow fadeInDown" data-wow-delay="0.6s">
                        ...
                        <p>La communauté otaku s’accroît de jour en jour. Si vous êtes un nouveau fan de manga et d’Animé, il y a des mangas incontournables à lire absolument. Voici une sélection des mangas que...</p>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special wow fadeInDown" data-wow-delay="0.4s">
                        ...
                        <p>La France est un pays touristique qui dispose de nombreux sites dont les meilleures altitudes favorables pour le ski au monde. En effet, les Alpes...</p>
            ...
            <div class="modal fade" id="modal_red_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Aménagement du salon</h5>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-md-10 col-lg-8" style="margin: auto;">
                    ...
                    <button class="collapsibles">Aménagement du salon</button>
                    <div class="contenu">
                        <p>
                            <h1 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Aménagement
                            d’un salon&nbsp;: conseils de pro</span></h1>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Étudier avec soin l’orientation du salon</span></h2>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Prévoir
                            et organiser les rangements</span></h2>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Prendre
                            le mobilier adapté au salon</span></h2>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Être attentif à l’éclairage de votre salon</span></h2>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Jouer
                            avec les contrastes en matière de décoration</span></h2>
                            ...
                            <h2 style="margin-top:0cm"><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;">Créer
                            plusieurs espaces dans votre salon</span></h2>
                    ...
                    <button class="collapsibles">Quels meilleurs manga à lire</button>
                    <div class="contenu">
                        <p>
                            <h1 style="margin-left:0cm;text-indent:0cm;mso-list:l0 level1 lfo1">Quels bons
                            mangas à lire&nbsp;?</h1><p class="MsoNormal">La communauté otaku s’accroît de jour en jour. Si vous êtes
                            ...
                            marques dans ce monde.</p><h2 style="margin-left:0cm;text-indent:0cm;mso-list:l0 level2 lfo1">Death Note</h2>
                            ...
                            <h2 style="margin-left:0cm;text-indent:0cm;mso-list:l0 level2 lfo1">Naruto</h2>
                            ...
                            <h2 style="margin-left:0cm;text-indent:0cm;mso-list:l0 level2 lfo1">One piece</h2>
                    ...
                    <button class="collapsibles">Top 5 des meilleurs stations de ski en France</button>
                    <div class="contenu">
                        <p>

                            <h1>Top 5 des meilleurs station de Ski en France</h1>
                            ...
                            <h2>Val Thorens (Savoie-Aples)</h2>
                            ...
                            <h2>Chamonix-Mont Blanc (Haute-Savoie)</h2>
                            ...
                            <h2>La plagne – Les Arcs (Hautes-Aples)</h2>
