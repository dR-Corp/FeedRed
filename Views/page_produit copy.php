          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <h2>L'offre que <em>nous proposons</em> &amp; <span>pour vous </span>
                Un compte client pour <em>déléguer</em>, <span>gagner du temps</span> et <em>suivre en temps réel</em>
                </h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus harum odio voluptate accusa praesentium vel debitis, deserunt eligendi! Ad numquam doloribus illo ab!</p>
                <form id="search" action="#" method="GET">
                  <fieldset>
                    <input type="address" name="address" class="email" placeholder="Votre adresse mail ..." autocomplete="on" required>
                  </fieldset>
                  <fieldset>
                    <button type="submit" class="main-button">Demander compte client</button>
                  </fieldset>
                </form>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="<?= ASSETS;?>space/assets/images/banner-right-image.png" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="section-heading">
            <h2>Notre <em>produit</em> pour répondre à vos &amp; <span>exigences</span></h2>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, itaque! Ad dolorum nobis repellendus magnam totam nemo, aperiam reiciendis provident corrupti, laborum accusamus velit enim architecto cumque placeat rerum numquam!.</p>
          </div>
          <div class="row">
            <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading  wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <h2>Bénéficiez des <em>avantages</em> &amp; hors du <span>commun</span></h2>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <div class="section-heading">
            ...
            <div class="phone-info">
              <h4>Nos contacts: <span><i class="fa fa-phone"></i> +229 96 42 91 16</span></h4>
            </div>
            <div class="phone-info">
              <h4><span style="visibility: hidden;">Nos contacts:</span> <span><i class="fa fa-envelope"></i> contact@feed-agency.com</span></h4>
            </div>
          </div>
        </div>
