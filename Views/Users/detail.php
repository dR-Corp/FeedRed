...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-2">
        <a href="users.html"><button class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#addModal"><i class="fas fa-angle-left" aria-hidden="true"></i> Retour</button></a>
        </div>
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
