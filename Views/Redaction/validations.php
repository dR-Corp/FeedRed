<script>
    $(function () {
        $("#table_redactions").DataTable({
            ...
            "ajax": {
                "url" : "reload-redaction-validable.html",
                "method": "POST",
                "data": {},
                "dataSrc": ""
            },
            "columns": [
                ...
                {"data": null,
                    render: function(data, type, row) {
                        ...
                        var detail = '<a href="detail-ad-redaction.html~id~'+row.idRedaction+'~retour~3" data-tog="tooltip" data-placement="bottom" title="Détails de la redaction" class="btn btn-xs btn-info text-white detailBtn"><i class="fas fa-folder-open" aria-hidden="true"></i></a>';
                        if(row.etat == 2) {
