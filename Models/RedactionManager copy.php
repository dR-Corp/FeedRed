...
class RedactionManager {
    ...
    public function saveCli($values) {
        ...
        $titre = $values['article_data']['titre'];

        //enregistremnte de la rédaction dans un fichier docx
        // $red = preg_replace('/[\t]+/', ' ', $red);
        // $red = preg_replace('/\s\s+/', ' ', $red);
        // $red = preg_replace('/[\n\r]+/', '\n', $red);
        ...
        // $matches = [];
        // preg_match_all('#<(h2|h3|p)>(.*?)</\1>#s', html_entity_decode($red), $matches);
        ...
        // // Add a text run and set the font
        // $textrun = $section->addTextRun();
        // $textrun->setFont("Times New Roman", 12);
        // // Add the content to the section
        // $textrun->addText($red);
        // // $textrun->addText(nl2br($red));
        // $textrun->setAlignment(\PhpOffice\PhpWord\SimpleType\Jc::BOTH);
        ...
        $req->bindValue(':idArticle', $values['article_data']['idArticle'], PDO::PARAM_INT);
        $req->bindValue(':idRedacteur', 0, PDO::PARAM_INT);

        $req->bindValue(':idClient', $values['article_data']['idClient'], PDO::PARAM_STR);
        ...
        $manage->writtedArticle([
            'idArticle' => $values['article_data']['idArticle'],
            'idRedacteur' => 0
        ]);
