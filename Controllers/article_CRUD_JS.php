                ...
                <div class="modal-body mt-3">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" name="values[urgence]" type="checkbox" id="urgence">
                            <label for="urgence" class="custom-control-label text-warning">Urgent</label>
                        </div>
                    </div>
                    <?php endif; ?>
...
<script>
    ...
    $(function () {
        ...
        var tableArticle = $("#table_articles").DataTable({
            ...
            "columns": [
                ...
                {"data": "etat",
                    render: function(data, type, row) {
                        ...
                        if(row.etat == 0 || row.etat == null) {
                            ...
                            stateText = '<span class="badge badge-primary">Pris</span>';
                        }
                        else if(row.etat == 3) {
                            ...
                            stateText = '<span class="badge badge-info">Confié</span>';
                        }
                        else {
                ...
                {"data": null,
                    render: function(data, type, row) {
                        if(row.redacteur[0] == 0 || row.redacteur[0] == null) {
                            return '<span class="badge badge-info" >Aucun</span>';
                        }
                        else {
                            return '<a href="detail-users.html~id~'+row.redacteur[0]+'"><span class="badge">'+row.redacteur[1]+'</span></a>';
                        }
                    }
                },
                {"data": null,
    ...
    $('#addForm').on('click', function() {
        ...
        var delai = $('#delai').val();
        var urgence = $('#urgence').prop('checked');
